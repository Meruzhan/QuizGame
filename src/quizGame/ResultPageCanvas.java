...
public class ResultPageCanvas extends Canvas {
    ...
    private void drawResultPage(Graphics g) {
        ...
        g.drawString(getResultMessage(),HEADER_CONTENT_X+190,HEADER_CONTENT_Y+85);
        ...
        g.drawString(userName,RESULT_AREA_X+100,RESULT_AREA_Y+70);
        g.drawString("you have a "+correctAnswersCount,RESULT_AREA_X+100,RESULT_AREA_Y+110);
        g.drawString("right answers",RESULT_AREA_X+100,RESULT_AREA_Y+150);
